...
namespace Lykke.Service.ChainalysisProxy.AutorestClient
{
    ...
    public static partial class ChainalysisProxyAPIExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> UserByUserIdGetChainalysisIdGetAsync(this IChainalysisProxyAPI operations, string userId, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UserByUserIdGetChainalysisIdGetWithHttpMessagesAsync(userId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
